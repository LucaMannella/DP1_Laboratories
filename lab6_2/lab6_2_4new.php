	...
	<body>
		<?php		
			...
			if(($reqName==="")||($reqSurname==="")) {
				echo "<p>Do you have inserted an empty string?! <BR> Go ",
				"<a href='lab6_2_4.html'>here</a> and enter your data again, please!</p>";
				die();
			}
			
			if (!isset( $_COOKIE[$reqName."-".$reqSurname] ))
			{
				setcookie($reqName."-".$reqSurname, "visitated", 0, "/");
